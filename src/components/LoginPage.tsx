        ...
        <div className="flex items-center justify-center min-h-screen bg-slate-950">
            <div className="w-full max-w-sm p-8 bg-slate-900 rounded-xl border border-slate-800 shadow-2xl">
                ...
                <button
                    ...
                    disabled={isSubmitting}
                    className="w-full p-3 rounded-lg bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm transition disabled:opacity-50 flex items-center justify-center gap-2 shadow-sm"
                >
                    {/* SVG โลโก้ Google */}
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                        ...
                        <path
                            fill="#34A853"
                            d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.88-3.05c-1.08.72-2.45 1.16-4.05 1.16-3.13 0-5.78-2.11-6.73-4.96H1.18v3.14C3.15 21.35 7.23 24 12 24z"
                        />
                        <path
                            fill="#FBBC05"
                        ...
                        <path
                            fill="#EA4335"
                            d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.23 0 3.15 2.65 1.18 6.62l4.09 3.14c.95-2.85 3.6-4.91 6.73-4.91z"
                        />
                    </svg>
